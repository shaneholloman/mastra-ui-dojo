...
const MSG_1 = "I'm planning a two-week spring trip across Japan — Tokyo, Kyoto, Osaka, and Hiroshima. I care about cherry blossoms, great food, and avoiding crowds. Help me shape a rough itinerary.";
const MSG_2 = "Also: I'm vegetarian, I love quiet gardens and photography, I want one ryokan night with an onsen, and I prefer trains over buses. What would you adjust, and what shouldn't I miss?";
